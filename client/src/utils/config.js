...
export const RESET_PASS_URL = `${BASE_URL}/api/user/resetpassword`;
export const FORGOT_PASS_URL = `${BASE_URL}/api/user/sendreset`;
...
export const SELLER_ORDERS = `${BASE_URL}/api/order/seller`;
export const ORDER_COD = `${BASE_URL}/api/order/cod`;
export const GET_ALLORDERS = `${BASE_URL}/api/admin/orders`;
